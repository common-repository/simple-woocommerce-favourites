...
Tags: woocommerce, favourites, products
...
1. The ‘Add to Favourites’ button will be added to your products automatically.
2. Click to add products
3. Display each user’s favourites wherever you like with a simple shortcode.
...
= 2.0 =
* Improvements to plugin structure
